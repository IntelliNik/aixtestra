...
public enum AnsiColor {
    ...
    @Contract(pure = true)
    @Deprecated
    public @NotNull String colorize(String stringToColorize) {
     ...
     */
    @Contract(pure = true)
    public static @NotNull String stripColors(@NotNull String coloredString) {
        return coloredString.replaceAll("\u001B\\[(0|3[0-7])m", "");
    }

    public static @Nullable AnsiColor fromName(String name) {
